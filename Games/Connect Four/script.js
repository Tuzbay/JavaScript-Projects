...
checkboard = () => {
  for (let y = 0; y < winningArray.length; y++) {
    ...
    // Check those squares to if they all have the class of player-one
    ...
    // Check those squares to if they all have the class of player-two
...
for (let i = 0; i < squares.length; i++) {
  squares[i].onclick = () => {
    ...
    } else alert("This square is full or it's bottom square is empty.");
    checkboard();
  };
}
